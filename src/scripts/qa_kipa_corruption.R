...
oddities <- c(
  ...
  "`corr_bribery_experience_1yr` is GATED in ALL waves 2016–2021: a prior screener ('did you have contact with officials in the past year?') routes only YES-respondents to the bribery question. Routed-out per n=1,000: 2016=538, 2017=499, 2018=497, 2019=537, 2020=575, 2021=487 (비해당 = -1 → NA). The denominator for these waves is 'respondents with official contact', not the full sample — flag this in Methods, and use `kipa_bribery_series()` (src/r/lookups/), which reports both denominators. `gated_waves: [2016, 2017, 2018, 2019, 2020, 2021]` in the YAML suppresses the NA-rate warning; the QA script still prints a [gate] note showing the NA%. Only 2016/2019/2020 are gated in the printed codebooks, but all six are gated in the data.",
