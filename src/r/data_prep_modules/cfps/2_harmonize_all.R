...
#
# Sources the shared harmonization engine, then processes all CFPS YAML specs
# from src/config/cfps/harmonize/
#
# STATUS: SCAFFOLD. The specs in src/config/cfps/harmonize/ carry no resolved
# source-variable names yet — run 00_probe_variables.R and fill them in first.
# This file itself is complete; it is the standard thin wrapper.
