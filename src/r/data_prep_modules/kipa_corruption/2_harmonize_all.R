# KIPA Corruption: Harmonize all variables from YAML specs
...
if (sys.nframe() == 0) {
  cat("\n")
  cat(strrep("=", 70), "\n")
  cat("KIPA CORRUPTION HARMONIZATION PIPELINE\n")
  cat(strrep("=", 70), "\n\n")
  ...
  harmonized_wide <- stack_harmonized_wide(results, waves, survey = "kipa_corruption")
  ...
  cat("\n✅ KIPA Corruption harmonization complete\n")
}
