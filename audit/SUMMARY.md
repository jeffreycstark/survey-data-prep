# Audit summary — 2026-08-07 15:56:22 +07

git_commit: `452877a`  git_dirty: false

Mode: `--quick` (G1, F4 skipped) — single survey `abs`
Runtime: 143.2 s
...
|--------|-----------|---------------|--------|-------------|------------|-----------|-----------|------------|-------------|-------------|----------|-----------|----------|
| abs | OK 28/28 | FAIL err=3 warn=88 | warn 0 err, 15 warn | skip --quick | FAIL 5 constructs, 7 sign-disagreements, 719 weak (+107 ack) | OK 562 ok, 0 fail, 0 skip | OK 413 ok, 0 err, 720 skip | warn 583 ok, 94 hint, 91 weak | warn 44 cov, 16 ex, 207 unc | FAIL 1034 ok, 56 err, 2 warn | skip --quick | OK all paths match | OK all inputs unchanged |
...
3. **[abs]** L4 binwidth — corrupt_local_govt/w6: bin signature 4:1|3:1|2:1|1:2 diverges from sibling waves  
   See `audit/reports/abs/`
4. **[abs]** L4 anchors — economic_evaluations/econ_outlook_1yr/w1: expected=positive observed=negative  
   See `audit/reports/abs/`
5. **[abs]** L4 anchors — economic_evaluations/econ_family_outlook/w1: expected=positive observed=negative  
   See `audit/reports/abs/`
6. **[abs]** L4 anchors — economic_evaluations/gov_basic_necessities/w2: expected=positive observed=negative  
   See `audit/reports/abs/`
7. **[abs]** L3 invariants — idnumber/w6/coverage: Gained 19 values (harmonized > raw) - check logic  
   See `audit/reports/abs/`
8. **[abs]** L3 invariants — gate_contact_influential/w2/coverage: 30.0% coverage loss (4006 of 13347 values)  
   See `audit/reports/abs/`
9. **[abs]** L3 invariants — gate_contact_influential/w2/crosstab: 3 raw values map to multiple outputs  
   See `audit/reports/abs/`
...
---
Generated by `src/r/audit/run_all.R` at 2026-08-07 15:56:22 +07.
