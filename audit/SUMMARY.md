# Audit summary — 2026-05-10 18:47:48 +07

git_commit: `911f70a`  git_dirty: **true**
...
|--------|-----------|---------------|-------------|------------|-----------|----------|-----------|----------|
| abs | OK 28/28 | FAIL err=32 warn=130 | skip --quick | FAIL 3 constructs, 114 sign-disagreements, 435 weak | OK 512 ok, 0 fail, 0 skip | skip --quick | OK all paths match | OK all inputs unchanged |
...
| afro | OK 14/14 | FAIL err=62 warn=24 | skip --quick | skip no applicable anchors (anchor var absent) | skip 0 ok, 0 fail, 24 skip | skip --quick | FAIL exit=1 | OK all inputs unchanged |
| arab-barometer | OK 9/9 | FAIL err=18 warn=10 | skip --quick | skip no applicable anchors (anchor var absent) | skip 0 ok, 0 fail, 78 skip | skip --quick | skip no manifest | skip no manifest |
| kamos | OK 6/6 | FAIL err=11 warn=2 | skip --quick | skip no applicable anchors (anchor var absent) | skip 0 ok, 0 fail, 8 skip | skip --quick | skip no manifest | skip no manifest |
...
5. **[afro]** L3 invariants — dem_satisfaction/w2/coverage: 1.6% coverage loss (355 of 22005 values)  
   See `audit/reports/afro/`
6. **[afro]** L3 invariants — dem_satisfaction/w3/coverage: 1.8% coverage loss (391 of 21287 values)  
   See `audit/reports/afro/`
...
---
Generated by `src/r/audit/run_all.R` at 2026-05-10 18:47:48 +07.
