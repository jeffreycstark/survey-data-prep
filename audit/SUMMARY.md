# Audit summary — 2026-08-10 12:18:01 +07

git_commit: `0ba675e`  git_dirty: **true**
...
| evs_wvs_joint | OK 4/4 | skip --specs-only | skip --specs-only | skip --specs-only | skip --specs-only | skip --specs-only | skip --specs-only | skip --specs-only | skip --specs-only | skip --specs-only | skip --specs-only | skip --specs-only | skip --specs-only |
...
- **evs_wvs_joint**: L3 invariants (--specs-only); L3 out-of-range (--specs-only); L2 codebook (--specs-only); L4 anchor (--specs-only); L4 strict reversal (--specs-only); L4 label recon (--specs-only); L4 battery coherence (--specs-only); L4 anchor coverage (--specs-only); L4 bin-width parity (--specs-only); L5 drift (--specs-only); L6 determinism (--specs-only); L6 input drift (--specs-only)

---
Generated by `src/r/audit/run_all.R` at 2026-08-10 12:18:01 +07.
