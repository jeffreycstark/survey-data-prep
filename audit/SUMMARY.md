# Audit summary — 2026-05-12 12:11:07 +07

git_commit: `3b89197`  git_dirty: **true**
...
|--------|-----------|---------------|-------------|------------|-----------|----------|-----------|----------|
| abs | OK 28/28 | FAIL err=29 warn=130 | skip --quick | FAIL 3 constructs, 114 sign-disagreements, 435 weak | OK 512 ok, 0 fail, 0 skip | skip --quick | FAIL exit=1 | OK all inputs unchanged |
...
| afro | OK 14/14 | FAIL err=53 warn=24 | skip --quick | skip no applicable anchors (anchor var absent) | skip 0 ok, 0 fail, 24 skip | skip --quick | FAIL exit=1 | OK all inputs unchanged |
...
---
Generated by `src/r/audit/run_all.R` at 2026-05-12 12:11:07 +07.
