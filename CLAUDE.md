...
| Joint EVS/WVS 2017–2022 (ZA7505 v5.0.0) | Complete | 24 vars, 1 pooled cross-section, 156,658 resp, 92 country-surveys (22 CEE/post-communist); `uniqid` fully unique; ⚠️ separate from `wvs` — never row-bind (WVS7 overlaps); action_* items keep native 1=done→3=would-never (higher = withdrawal) | [docs/surveys/evs-wvs-joint.md](docs/surveys/evs-wvs-joint.md) |
